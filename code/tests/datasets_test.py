...
class DatasetTest(unittest.TestCase):
    ...
    def test_unequal_split(self):
        _, _, sample_train_dataset, sample_valid_dataset = make_train_and_valid_loaders(
            2, max_images=100, proportion_faces=0.6
        )
    ...
    def sample_idxs_from_valid_dataset(self):
        (
            ...
            sample_valid_dataset,
        ) = make_train_and_valid_loaders(1, max_images=100)
        subsample = sample_idxs_from_sub_dataset(
            [100, 200, 700], sample_valid_loader, 1
        )
